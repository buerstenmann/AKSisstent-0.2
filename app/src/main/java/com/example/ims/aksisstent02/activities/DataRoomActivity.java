...
//        room = (Room) xstream.fromXML(getIntent().getStringExtra("resultRoomAsString"));
//        menuContext = (Context) xstream.fromXML(getIntent().getStringExtra("menuActivityContext"));
//
//
...
//            timetable = timetableDAO.getTimetable(room.getRoomNumber(), 3, context);
//        } else {
//            System.out.println("TimetableDAO ist null");
//        }
//
//        System.out.println("setTeacher " + room + " ");
